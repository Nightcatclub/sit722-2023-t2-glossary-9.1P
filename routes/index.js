...
router.get('/', function(req, res, next) {
  const terms = [
    ...
    {
      id: 41,
      name: "Container Orchestration System",
      description: "Container orchestration is the automation of much of the operational effort required to run containerized workloads and services. This includes a wide range of things software teams need to manage a container’s lifecycle, including provisioning, deployment, scaling (up and down), networking, load balancing and more.",
      reference: "Vmware. (2023). What Is Container Orchestration? Vmware. https://www.vmware.com/topics/glossary/content/container-orchestration.html",
    },{
      id: 42,
      name: "OpenShift",
      description: "Red Hat OpenShift, the industry's leading hybrid cloud application platform powered by Kubernetes, brings together tested and trusted services to reduce the friction of developing, modernizing, deploying, running, and managing applications. OpenShift delivers a consistent experience across public cloud, on-premise, hybrid cloud, or edge architecture.",
      reference: "Redhat. (2023). What Is Red Hat OpenShift. Redhat. https://www.redhat.com/en/technologies/cloud-computing/openshift",
    },{
      id: 43,
      name: "Role-based access control",
      description: "When using RBAC for Role Management, you analyze the needs of your users and group them into roles based on common responsibilities. You then assign one or more roles to each user and one or more permissions to each role. The user-role and role-permissions relationships make it simple to perform user assignments since users no longer need to be managed individually, but instead have privileges that conform to the permissions assigned to their role(s).",
      reference: "Auth0. (2023). Ole-Based Access Control. Auth0. https://auth0.com/docs/manage-users/access-control/rbac",
    },{
      id: 44,
      name: "Platform-as-a-service (PaaS)",
      description: "Platform as a service (PaaS) is a complete development and deployment environment in the cloud, with resources that enable you to deliver everything from simple cloud-based apps to sophisticated, cloud-enabled enterprise applications. You purchase the resources you need from a cloud service provider on a pay-as-you-go basis and access them over a secure Internet connection.",
      reference: "Azure. (2023). What Is PaaS? Microsoft. https://azure.microsoft.com/en-us/resources/cloud-computing-dictionary/what-is-paas",
    },{
      id: 45,
      name: "Container-as-a-service (CaaS)",
      description: "Containers as a service (CaaS) is a cloud-based service that allows software developers and IT departments to upload, organize, run, scale, and manage containers by using container-based virtualization.",
      reference: "buchanan, I. (2023). What Is Containers as a Service? Atlassian. https://www.atlassian.com/microservices/cloud-computing/containers-as-a-service",
    },{
      id: 46,
      name: "DevOps Release Management",
      description: "release management refers to the process of planning, coordinating and deploying software releases to production environments. The goal of release management is to ensure that new features, bug fixes, and enhancements are delivered to end-users in a reliable, efficient, and timely manner.",
      reference: "Watts, stephen . (2023). DevOps Release Management Concepts & Best Practices. Splunk. https://www.splunk.com/en_us/blog/learn/devops-release-management.html",
    },{
      id: 47,
      name: "Configuration Management",
      description: "onfiguration Management is the process of maintaining systems, such as computer hardware and software, in a desired state. Configuration Management (CM) is also a method of ensuring that systems perform in a manner consistent with expectations over time.",
      reference: "Vmware. (2023). What Is Configuration Management? Vmware. https://www.vmware.com/topics/glossary/content/configuration-management.html",
    },{
      id: 48,
      name: "feedback loop",
      description: "A feedback loop is the part of a system in which some portion (or all) of the system's output is used as input for future operations. Each feedback loop has a minimum of four stages. During the first stage, input is created. During the second stage, input is captured and stored. During the third stage, input is analyzed and during the fourth stage, the insight gained from analysis is used to make decisions.",
      reference: "Fitzgibbons, L. (2023). Feedback Loop. Techtarget. https://www.techtarget.com/searchitchannel/definition/feedback-loop",
    },{
      id: 49,
      name: "Virtualization",
      description: "Virtualization is technology that you can use to create virtual representations of servers, storage, networks, and other physical machines. Virtual software mimics the functions of physical hardware to run multiple virtual machines simultaneously on a single physical machine. Businesses use virtualization to use their hardware resources efficiently and get greater returns from their investment. It also powers cloud computing services that help organizations manage infrastructure more efficiently.",
      reference: "Aws. (2023). What Is Virtualization? Amazon. https://aws.amazon.com/what-is/virtualization/?nc1=h_ls",
    },{
      id: 50,
      name: "Clusters",
      description: "A cluster is a group of data whose members are more similar to each other than they are to items in another group. This is useful in the State of DevOps report as it allows many organizations to be arranged methodically for comparison.",
      reference: "Fenton, S. (2023). The New DevOps Performance Clusters. Octopus. https://octopus.com/blog/new-devops-performance-clusters",
    },
  ];
